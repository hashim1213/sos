          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <Link href="/" className="flex items-center">
                ...
                />
                <span className="text-xl font-bold">StaffOnSite</span>
              </Link>
            </div>
            ...
            <nav className="hidden md:flex space-x-6">
              <a href="#how-it-works" className="hover:text-red-400 transition text-sm">
                How It Works
              </a>
              <a href="#benefits" className="hover:text-red-400 transition text-sm">
                Benefits
              </a>
              <a href="#verification" className="hover:text-red-400 transition text-sm">
                Verification
              </a>
              <a href="#testimonials" className="hover:text-red-400 transition text-sm">
                Testimonials
              </a>
              <Link href="/hire" className="text-red-500 hover:text-red-400 transition text-sm font-bold">
                Hire Now
              </Link>
            </nav>
          </div>
          ...
          {mobileMenuOpen && (
            <nav className="md:hidden pt-4 pb-2">
              <ul className="space-y-2">
                <li>
                  <a href="#how-it-works" className="block hover:text-red-400" onClick={() => setMobileMenuOpen(false)}>
                    How It Works
                  </a>
                </li>
                <li>
                  <a href="#benefits" className="block hover:text-red-400" onClick={() => setMobileMenuOpen(false)}>
                    Benefits
                  </a>
                </li>
                <li>
                  <a href="#verification" className="block hover:text-red-400" onClick={() => setMobileMenuOpen(false)}>
                    Verification
                  </a>
                </li>
                <li>
                  <a href="#testimonials" className="block hover:text-red-400" onClick={() => setMobileMenuOpen(false)}>
                    Testimonials
                  </a>
                </li>
                <li>
                  <Link
                    href="/hire"
                    className="block text-red-500 hover:text-red-400 font-bold"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-12 max-w-2xl mx-auto">
              On-demand staff and vendors for your events - when you need them most. No more juggling spreadsheets or
              making desperate calls.
            </p>
            ...
            <div className="mt-12">
              {userPath === "organizer" ? (
                <Link
                  href="/hire"
                  className="bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-lg transition shadow-lg text-lg"
                >
                  Hire Staff Now
                </Link>
                ...
                <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                  <ul className="space-y-6">
                    <li className="flex items-start">
                      <div className="mt-1 mr-4 w-8 h-8 bg-red-500 rounded-full flex items-center justify-center text-white font-bold">
                        1
                      </div>
                      <div>
                        <h3 className="font-bold text-lg mb-1">
                          &quot;Half my staff just canceled for tomorrow&apos;s event!&quot;
                        </h3>
                        <p className="text-gray-700">
                          With SOS, you can find vetted, qualified replacements within hours.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start">
                      ...
                      <div>
                        <h3 className="font-bold text-lg mb-1">
                          &quot;I need 300 people for the Winnipeg Folk Festival in three days.&quot;
                        </h3>
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        <h3 className="font-bold text-lg mb-1">
                          &quot;I&apos;m scrambling to find bartenders, servers, and security for a wedding.&quot;
                        </h3>
                        <p className="text-gray-700">
                          From bartenders to security - find all your staffing needs in one place.
                        </p>
                      </div>
                    </li>
                  </ul>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="w-12 h-12 bg-red-500 text-white rounded-full flex items-center justify-center mb-4 font-bold text-xl">
                    1
                  </div>
                  <h3 className="text-xl font-bold mb-2 text-black">Describe Your Event</h3>
                  <p className="text-gray-700">
                    Tell us what you need - staff, vendors, equipment - and when you need it.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-700">
                    Our platform instantly shows you available, vetted professionals in your area.
                  </p>
                </div>
              ...
              <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Emergency staffing when you need it most - even with just hours to spare.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Staff, bartenders, security, equipment - everything you need in one place.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      From weddings in Banff to expos in Toronto - we&apos;ve got Canada covered.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="max-w-5xl mx-auto grid md:grid-cols-4 gap-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md text-center">
                  ...
                  <p className="text-gray-700">
                    Skills assessment and certification validation for specialized positions.
                  </p>
                </div>
              ...
              <div className="max-w-3xl mx-auto text-center">
                ...
                {!submitted ? (
                  <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-xl text-left">
                    ...
                    <div className="mb-6">
                      <label htmlFor="eventType" className="block text-gray-700 font-bold mb-2">
                        What type of events do you organize? (Optional)
                      </label>
                      <select
                        id="eventType"
                        value={eventType}
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-xl text-center">
                    ...
                    <button onClick={() => setSubmitted(false)} className="text-red-600 hover:text-red-800 font-medium">
        ...
        <>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      ...
                      <p className="text-gray-700 pl-11">
                        Earn premium rates, especially for emergency staffing needs.
                      </p>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      ...
                      <p className="text-gray-700 pl-11">
                        Earn ratings and reviews to increase your visibility and booking potential.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-700">
                    Share your skills, experience, and availability to stand out to event organizers.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-700">
                    Receive notifications when your skills match an event&apos;s needs in your area.
                  </p>
                </div>
          ...
          <section id="verification" className="py-16 bg-white">
            <div className="container mx-auto px-4">
              ...
              <p className="text-lg text-center mb-12 text-gray-700 max-w-3xl mx-auto">
                We maintain high standards to ensure quality opportunities for our professionals. Here&apos;s what to
                expect:
              </p>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="border-l-4 border-red-500 pl-6 mb-8">
                  ...
                  <p className="text-gray-700 mb-2">
                    We conduct thorough background checks to maintain platform integrity.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-red-500 pl-6 mb-8">
                  ...
                  <p className="text-gray-700 mb-2">
                    Your certifications and skills will be verified to match you with appropriate events.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-red-500 pl-6 mb-8">
                  ...
                  <p className="text-gray-700 mb-2">
                    After each event, you&apos;ll receive ratings and feedback to build your reputation.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-red-500 pl-6">
                  ...
                  <p className="text-gray-700 mb-2">
                    Consistent performance leads to more opportunities and higher-paying gigs.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-xl text-left text-black">
                    <form onSubmit={handleSubmit}>
                      ...
                      <button
                        ...
                        } text-white font-bold py-3 px-6 rounded-lg transition shadow-lg`}
                      >
                        {isSubmitting ? "Submitting..." : "Apply to Join"}
                      </button>

                      {submitError && <p className="mt-3 text-red-600 text-center">{submitError}</p>}
                    </form>
                  </div>
                ) : (
                  <div className="bg-white p-6 rounded-lg shadow-xl text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                      Thanks for your interest in joining the SOS professional network. We&apos;ll review your
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                &quot;When 30 security staff canceled the day before our festival, SOS saved us. Within hours, we had
                qualified replacements ready to work.&quot;
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                &quot;I used to spend days finding reliable bartenders and servers. Now with SOS, I can book vetted
                staff in minutes. A game-changer!&quot;
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                &quot;SOS has connected me with quality gigs that fit my schedule. The verification process was thorough
                but worth it for the premium opportunities.&quot;
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h2 className="text-2xl font-bold flex items-center">
                ...
                />
                <span>StaffOnSite</span> <span className="ml-2 text-sm">Staff On Shift</span>
              </h2>
            ...
            <div className="text-sm text-gray-400 text-center mt-6 md:mt-0">
              &copy; {new Date().getFullYear()} StaffOnSite. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
